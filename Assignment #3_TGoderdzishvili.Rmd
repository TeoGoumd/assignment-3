...
text <- pdf_text("../exercises/moley/extracted/moley.PDF")

#pdf_text reads the text from a PDF file.
writeLines(text, "../exercises/moley/moley.txt")
...
#AIW_index <- read_lines("assets/extracted_text/AIW_extracted_1.txt")
